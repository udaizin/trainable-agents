...
checkpoint = "/work/trainable-agents/FastChat/models/character-llm-beethoven-7b-wdiff"
...
def generate_response(meta_prompt, character, loc_time, status):
    ...
    outputs = model.generate(**inputs, do_sample=True, temperature=0.5, top_p=0.95, max_new_tokens=200)
