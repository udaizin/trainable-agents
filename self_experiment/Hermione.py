...
checkpoint = "/work/trainable-agents/FastChat/models/character-llm-hermione-7b-wdiff"
...
character = "Hermione"
loc_time = "Classroom - Morning"
status = f'{character} talks with Ron Weasley about Wingardrium Leviosar.'
